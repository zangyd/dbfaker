...
class TableTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->table = new \zangyd\dbfaker\Table(self::TABLE_NAME, new Generator(), new \zangyd\dbfaker\DbHelper(new PDO('sqlite::memory:')));
    ...
    public function testConstruct()
    {
        ...
        $this->assertInstanceOf('zangyd\dbfaker\Generator', Helper::getPrivateValue($this->table, 'generator'));
        $this->assertInstanceOf('zangyd\dbfaker\DbHelper', Helper::getPrivateValue($this->table, 'dbHelper'));
    }
