...
{
    /** @var \zangyd\dbfaker\Seeder */
    private $seeder;
    private $_pdo;

    public function setUp()
    {
        $this->seeder = new \zangyd\dbfaker\Seeder($this->getPdo());
    }

    public function testConstructor()
    {
        $this->assertInstanceOf('zangyd\dbfaker\GeneratorConfigurator', Helper::getPrivateValue($this->seeder, 'generatorConfigurator'));
        $this->assertInstanceOf('zangyd\dbfaker\DbHelper', Helper::getPrivateValue($this->seeder, 'dbHelper'));
        $this->assertInstanceOf('zangyd\dbfaker\Generator', Helper::getPrivateValue($this->seeder, 'generator'));
    }

    public function testTable()
    {
        $ret = $this->seeder->table('abc');
        $this->assertInstanceOf('zangyd\dbfaker\TableConfigurator', $ret);
        $this->assertInstanceOf('zangyd\dbfaker\Table', Helper::getPrivateValue($this->seeder, 'tables')['abc']);
    }
